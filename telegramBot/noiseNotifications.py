...
# Define the time threshold as 10:30 PM
notification_time = datetime.datetime.now().replace(hour=22, minute=30, second=0, microsecond=0)

if datetime.datetime.now() >= notification_time:
